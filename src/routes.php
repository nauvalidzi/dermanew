...
return function (App $app) {
    ...
    // npd_extend
    $app->any('/NpdExtendList[/{id}]', NpdExtendController::class . ':list')->add(PermissionMiddleware::class)->setName('NpdExtendList-npd_extend-list'); // list
    $app->any('/NpdExtendAdd[/{id}]', NpdExtendController::class . ':add')->add(PermissionMiddleware::class)->setName('NpdExtendAdd-npd_extend-add'); // add
    $app->any('/NpdExtendView[/{id}]', NpdExtendController::class . ':view')->add(PermissionMiddleware::class)->setName('NpdExtendView-npd_extend-view'); // view
    $app->any('/NpdExtendEdit[/{id}]', NpdExtendController::class . ':edit')->add(PermissionMiddleware::class)->setName('NpdExtendEdit-npd_extend-edit'); // edit
    $app->any('/NpdExtendDelete[/{id}]', NpdExtendController::class . ':delete')->add(PermissionMiddleware::class)->setName('NpdExtendDelete-npd_extend-delete'); // delete
    $app->group(
        '/npd_extend',
        function (RouteCollectorProxy $group) {
            $group->any('/' . Config("LIST_ACTION") . '[/{id}]', NpdExtendController::class . ':list')->add(PermissionMiddleware::class)->setName('npd_extend/list-npd_extend-list-2'); // list
            $group->any('/' . Config("ADD_ACTION") . '[/{id}]', NpdExtendController::class . ':add')->add(PermissionMiddleware::class)->setName('npd_extend/add-npd_extend-add-2'); // add
            $group->any('/' . Config("VIEW_ACTION") . '[/{id}]', NpdExtendController::class . ':view')->add(PermissionMiddleware::class)->setName('npd_extend/view-npd_extend-view-2'); // view
            $group->any('/' . Config("EDIT_ACTION") . '[/{id}]', NpdExtendController::class . ':edit')->add(PermissionMiddleware::class)->setName('npd_extend/edit-npd_extend-edit-2'); // edit
            $group->any('/' . Config("DELETE_ACTION") . '[/{id}]', NpdExtendController::class . ':delete')->add(PermissionMiddleware::class)->setName('npd_extend/delete-npd_extend-delete-2'); // delete
        }
    );
    ...
    // v_stock
    $app->any('/VStockList', VStockController::class . ':list')->add(PermissionMiddleware::class)->setName('VStockList-v_stock-list'); // list
    $app->group(
        '/v_stock',
        function (RouteCollectorProxy $group) {
            $group->any('/' . Config("LIST_ACTION") . '', VStockController::class . ':list')->add(PermissionMiddleware::class)->setName('v_stock/list-v_stock-list-2'); // list
        }
    );
    ...
    // maklon_produk
    $app->any('/MaklonProduk[/{params:.*}]', MaklonProdukController::class)->add(PermissionMiddleware::class)->setName('MaklonProduk-maklon_produk-custom'); // custom
