...
class IjinhakiList extends Ijinhaki
{
    ...
    public function getFilterList()
    {
        ...
        $filterList = Concat($filterList, $this->buktibayar->AdvancedSearch->toJson(), ","); // Field buktibayar
    ...
    {
        $where = "";
        $this->buildBasicSearchSql($where, $this->buktibayar, $arKeywords, $type);
    ...
    public function pageDataRendered(&$footer)
    {
        ...
        function selesai(id) {
    		$.get('".domain()."/api/ijinhaki/selesai/'+id, function(data) {
    			if (data == 1) {
    				location.reload();
    			} else {
        ...
        function belumselesai(id) {
    		$.get('".domain()."/api/ijinhaki/belumselesai/'+id, function(data) {
    			if (data == 1) {
    				location.reload();
    			} else {
    ...
    public function listOptionsRendered()
    {
        ...
        if ($this->selesai->CurrentValue == 1) {
