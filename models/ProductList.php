...
class ProductList extends Product
{
    ...
    public function getFilterList()
    {
        ...
        $filterList = Concat($filterList, $this->idkemasanbarang->AdvancedSearch->toJson(), ","); // Field idkemasanbarang
    ...
    protected function restoreFilterList()
    {
        ...
        // Field idkemasanbarang
        $this->idkemasanbarang->AdvancedSearch->SearchValue = @$filter["x_idkemasanbarang"];
        $this->idkemasanbarang->AdvancedSearch->SearchOperator = @$filter["z_idkemasanbarang"];
        $this->idkemasanbarang->AdvancedSearch->SearchCondition = @$filter["v_idkemasanbarang"];
        $this->idkemasanbarang->AdvancedSearch->SearchValue2 = @$filter["y_idkemasanbarang"];
        $this->idkemasanbarang->AdvancedSearch->SearchOperator2 = @$filter["w_idkemasanbarang"];
        $this->idkemasanbarang->AdvancedSearch->save();
    ...
    protected function advancedSearchWhere($default = false)
    {
        ...
        $this->buildSearchSql($where, $this->idkemasanbarang, $default, false); // idkemasanbarang
        ...
        if (!$default && $this->Command == "search") {
            ...
            $this->idkemasanbarang->AdvancedSearch->save(); // idkemasanbarang
    ...
    protected function basicSearchSql($arKeywords, $type)
    {
        ...
        $this->buildBasicSearchSql($where, $this->idkemasanbarang, $arKeywords, $type);
    ...
    protected function checkSearchParms()
    {
        ...
        if ($this->idkemasanbarang->AdvancedSearch->issetSession()) {
            return true;
        }
    ...
    protected function resetAdvancedSearchParms()
    {
                ...
                $this->idkemasanbarang->AdvancedSearch->unsetSession();
    ...
    protected function restoreSearchParms()
    {
        ...
        // Restore advanced search values
                ...
                $this->idkemasanbarang->AdvancedSearch->load();
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->idbrand, $ctrl); // idbrand
            $this->updateSort($this->kode, $ctrl); // kode
            $this->updateSort($this->nama, $ctrl); // nama
            $this->updateSort($this->idkemasanbarang, $ctrl); // idkemasanbarang
            $this->updateSort($this->harga, $ctrl); // harga
            $this->updateSort($this->ukuran, $ctrl); // ukuran
    ...
    protected function loadSearchValues()
    {
        ...
        // idkemasanbarang
        if (!$this->isAddOrEdit() && $this->idkemasanbarang->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->idkemasanbarang->AdvancedSearch->SearchValue != "" || $this->idkemasanbarang->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
