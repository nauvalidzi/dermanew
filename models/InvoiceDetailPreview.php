...
class InvoiceDetailPreview extends InvoiceDetail
{
    ...
    protected function setupSortOrder()
    {
        ...
        if ($this->CurrentOrder !== "") {
            $this->updateSort($this->idorder_detail, $ctrl); // idorder_detail
            $this->updateSort($this->jumlahorder, $ctrl); // jumlahorder
            $this->updateSort($this->bonus, $ctrl); // bonus
            $this->updateSort($this->stockdo, $ctrl); // stockdo
            $this->updateSort($this->jumlahkirim, $ctrl); // jumlahkirim
            $this->updateSort($this->jumlahbonus, $ctrl); // jumlahbonus
            $this->updateSort($this->harga, $ctrl); // harga
            $this->updateSort($this->totalnondiskon, $ctrl); // totalnondiskon
            $this->updateSort($this->diskonpayment, $ctrl); // diskonpayment
            $this->updateSort($this->bbpersen, $ctrl); // bbpersen
            $this->updateSort($this->totaltagihan, $ctrl); // totaltagihan
            $this->updateSort($this->blackbonus, $ctrl); // blackbonus
        }
    }
