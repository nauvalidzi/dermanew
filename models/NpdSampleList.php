...
class NpdSampleList extends NpdSample
{
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->sediaan, $ctrl); // sediaan
            $this->updateSort($this->ukuran, $ctrl); // ukuran
            $this->updateSort($this->warna, $ctrl); // warna
            $this->updateSort($this->bau, $ctrl); // bau
            $this->updateSort($this->fungsi, $ctrl); // fungsi
