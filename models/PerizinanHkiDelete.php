 ...
 * Page class
 */
class PerizinanHkiDelete extends PerizinanHki
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PerizinanHkiDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PerizinanHkiList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("PerizinanHkiList"); // Return to list
                return;
            }
        }
