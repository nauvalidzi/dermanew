...
class NpdHargaEdit extends NpdHarga
{
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // idviskositasbarang
            $this->idviskositasbarang->setDbValueDef($rsnew, $this->idviskositasbarang->CurrentValue, 0, $this->idviskositasbarang->ReadOnly);
            ...
            // bariskarton
            $this->bariskarton->setDbValueDef($rsnew, $this->bariskarton->CurrentValue, 0, $this->bariskarton->ReadOnly);

            // kolomkarton
            $this->kolomkarton->setDbValueDef($rsnew, $this->kolomkarton->CurrentValue, 0, $this->kolomkarton->ReadOnly);

            // stackkarton
            $this->stackkarton->setDbValueDef($rsnew, $this->stackkarton->CurrentValue, 0, $this->stackkarton->ReadOnly);

            // isikarton
            $this->isikarton->setDbValueDef($rsnew, $this->isikarton->CurrentValue, 0, $this->isikarton->ReadOnly);
            ...
            // orderperdana
            $this->orderperdana->setDbValueDef($rsnew, $this->orderperdana->CurrentValue, 0, $this->orderperdana->ReadOnly);

            // orderkontrak
            $this->orderkontrak->setDbValueDef($rsnew, $this->orderkontrak->CurrentValue, 0, $this->orderkontrak->ReadOnly);
