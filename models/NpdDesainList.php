...
class NpdDesainList extends NpdDesain
{
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->nama_produk, $ctrl); // nama_produk
            $this->updateSort($this->klaim_bahan, $ctrl); // klaim_bahan
            $this->updateSort($this->campaign_produk, $ctrl); // campaign_produk
            $this->updateSort($this->konsep, $ctrl); // konsep
            $this->updateSort($this->tema_warna, $ctrl); // tema_warna
            $this->updateSort($this->no_notifikasi, $ctrl); // no_notifikasi
            $this->updateSort($this->jenis_kemasan, $ctrl); // jenis_kemasan
            $this->updateSort($this->posisi_label, $ctrl); // posisi_label
            $this->updateSort($this->bahan_label, $ctrl); // bahan_label
            $this->updateSort($this->draft_layout, $ctrl); // draft_layout
