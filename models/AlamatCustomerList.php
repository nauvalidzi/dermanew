...
class AlamatCustomerList extends AlamatCustomer
{
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->alias, $ctrl); // alias
            $this->updateSort($this->idprovinsi, $ctrl); // idprovinsi
            $this->updateSort($this->idkabupaten, $ctrl); // idkabupaten
            $this->updateSort($this->idkecamatan, $ctrl); // idkecamatan
            $this->updateSort($this->idkelurahan, $ctrl); // idkelurahan
            $this->updateSort($this->alamat, $ctrl); // alamat
            $this->updateSort($this->penerima, $ctrl); // penerima
