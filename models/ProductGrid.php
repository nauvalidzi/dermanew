...
class ProductGrid extends Product
{
    ...
    public function emptyRow()
    {
        ...
        if ($CurrentForm->hasValue("x_idkemasanbarang") && $CurrentForm->hasValue("o_idkemasanbarang") && $this->idkemasanbarang->CurrentValue != $this->idkemasanbarang->OldValue) {
            return false;
        }
    ...
    public function resetFormError()
    {
        ...
        $this->idkemasanbarang->clearErrorMessage();
    ...
    protected function loadFormValues()
    {
        ...
        if ($CurrentForm->hasValue("o_idkemasanbarang")) {
            $this->idkemasanbarang->setOldValue($CurrentForm->getValue("o_idkemasanbarang"));
        }
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // idkemasanbarang
            $this->idkemasanbarang->setDbValueDef($rsnew, $this->idkemasanbarang->CurrentValue, null, $this->idkemasanbarang->ReadOnly);
    ...
    protected function addRow($rsold = null)
    {
        ...
        // idkemasanbarang
        $this->idkemasanbarang->setDbValueDef($rsnew, $this->idkemasanbarang->CurrentValue, null, false);
