...
class NpdAdd extends Npd
{
    ...
    protected function addRow($rsold = null)
    {
        ...
        // idkemasanbarang
        $this->idkemasanbarang->setDbValueDef($rsnew, $this->idkemasanbarang->CurrentValue, 0, false);
    ...
    public function formCustomValidate(&$customError)
    {
        ...
        $dataCustomer = ExecuteRow("SELECT c.ktp, c.npwp FROM customer c WHERE c.id=".$this->idcustomer->FormValue.");
