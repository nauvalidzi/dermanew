...
class Npd extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // idkemasanbarang
        $this->idkemasanbarang = new DbField('npd', 'npd', 'x_idkemasanbarang', 'idkemasanbarang', '`idkemasanbarang`', '`idkemasanbarang`', 3, 11, -1, false, '`idkemasanbarang`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        $this->idkemasanbarang->Nullable = false; // NOT NULL field
        $this->idkemasanbarang->Required = true; // Required field
        $this->idkemasanbarang->Sortable = true; // Allow sort
        ...
        // label
        $this->label = new DbField('npd', 'npd', 'x_label', 'label', '`label`', '`label`', 200, 100, -1, false, '`label`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->idkemasanbarang);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->idkemasanbarang);
