...
class NpdHargaList extends NpdHarga
{
    ...
    public function run()
    {
        ...
        $this->idviskositasbarang->Visible = false;
    ...
    public function getFilterList()
    {
        ...
        $filterList = Concat($filterList, $this->idviskositasbarang->AdvancedSearch->toJson(), ","); // Field idviskositasbarang
    ...
    protected function restoreFilterList()
    {
        ...
        // Field idviskositasbarang
        $this->idviskositasbarang->AdvancedSearch->SearchValue = @$filter["x_idviskositasbarang"];
        $this->idviskositasbarang->AdvancedSearch->SearchOperator = @$filter["z_idviskositasbarang"];
        $this->idviskositasbarang->AdvancedSearch->SearchCondition = @$filter["v_idviskositasbarang"];
        $this->idviskositasbarang->AdvancedSearch->SearchValue2 = @$filter["y_idviskositasbarang"];
        $this->idviskositasbarang->AdvancedSearch->SearchOperator2 = @$filter["w_idviskositasbarang"];
        $this->idviskositasbarang->AdvancedSearch->save();
    ...
    protected function basicSearchSql($arKeywords, $type)
    {
        ...
        $this->buildBasicSearchSql($where, $this->idviskositasbarang, $arKeywords, $type);
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->tglpengajuan, $ctrl); // tglpengajuan
            $this->updateSort($this->idnpd_sample, $ctrl); // idnpd_sample
            $this->updateSort($this->idaplikasibarang, $ctrl); // idaplikasibarang
            $this->updateSort($this->hargapcs, $ctrl); // hargapcs
            $this->updateSort($this->disetujui, $ctrl); // disetujui
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->bentuk->setSort("");
                $this->idviskositasbarang->setSort("");
