...
class NpdHarga extends DbTable
{
    ...
    public function __construct()
    {
        ...
        switch ($CurrentLanguage) {
            case "en":
                $this->idnpd_sample->Lookup = new Lookup('idnpd_sample', 'npd_sample', false, 'id', ["kode","","",""], ["x_idnpd"], [], ["idnpd"], ["x_idnpd"], [], [], '', '');
                break;
            default:
                $this->idnpd_sample->Lookup = new Lookup('idnpd_sample', 'npd_sample', false, 'id', ["kode","","",""], ["x_idnpd"], [], ["idnpd"], ["x_idnpd"], [], [], '', '');
                break;
        ...
        // idviskositasbarang
        $this->idviskositasbarang = new DbField('npd_harga', 'npd_harga', 'x_idviskositasbarang', 'idviskositasbarang', '`idviskositasbarang`', '`idviskositasbarang`', 3, 11, -1, false, '`idviskositasbarang`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        $this->idviskositasbarang->Nullable = false; // NOT NULL field
        $this->idviskositasbarang->Required = true; // Required field
        $this->idviskositasbarang->Sortable = true; // Allow sort
        $this->idviskositasbarang->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->idviskositasbarang->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        switch ($CurrentLanguage) {
            case "en":
                $this->idviskositasbarang->Lookup = new Lookup('idviskositasbarang', 'viskositasbarang', false, 'id', ["value","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->idviskositasbarang->Lookup = new Lookup('idviskositasbarang', 'viskositasbarang', false, 'id', ["value","","",""], [], [], [], [], [], [], '', '');
                break;
        }
        $this->idviskositasbarang->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->idviskositasbarang->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->idviskositasbarang->Param, "CustomMsg");
        $this->Fields['idviskositasbarang'] = &$this->idviskositasbarang;
        ...
        $this->bariskarton->Nullable = false; // NOT NULL field
        $this->bariskarton->Required = true; // Required field
        ...
        $this->kolomkarton->Nullable = false; // NOT NULL field
        $this->kolomkarton->Required = true; // Required field
        ...
        $this->stackkarton->Nullable = false; // NOT NULL field
        $this->stackkarton->Required = true; // Required field
        ...
        $this->isikarton->Nullable = false; // NOT NULL field
        $this->isikarton->Required = true; // Required field
        ...
        $this->orderperdana->Nullable = false; // NOT NULL field
        $this->orderperdana->Required = true; // Required field
        ...
        $this->orderkontrak->Nullable = false; // NOT NULL field
        $this->orderkontrak->Required = true; // Required field
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->idviskositasbarang->DbValue = $row['idviskositasbarang'];
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->idviskositasbarang);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->idviskositasbarang);
