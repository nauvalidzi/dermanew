 ...
 * Page class
 */
class PerizinanHkiView extends PerizinanHki
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PerizinanHkiView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "PerizinanHkiList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "PerizinanHkiList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "PerizinanHkiList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
