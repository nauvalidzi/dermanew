 ...
 * Page class
 */
class PerizinanHkiAdd extends PerizinanHki
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PerizinanHkiAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "PerizinanHkiView") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->akta_pendirian->CurrentValue = null;
        $this->akta_pendirian->OldValue = $this->akta_pendirian->CurrentValue;
        $this->surat_umk->CurrentValue = null;
        $this->surat_umk->OldValue = $this->surat_umk->CurrentValue;
        $this->ttd_pemohon->CurrentValue = null;
        $this->ttd_pemohon->OldValue = $this->ttd_pemohon->CurrentValue;
        $this->nama_merk->CurrentValue = null;
        $this->nama_merk->OldValue = $this->nama_merk->CurrentValue;
        $this->label_merk->CurrentValue = null;
        $this->label_merk->OldValue = $this->label_merk->CurrentValue;
        $this->label_deskripsi->CurrentValue = null;
        $this->label_deskripsi->OldValue = $this->label_deskripsi->CurrentValue;
        $this->unsur_warna->CurrentValue = null;
        $this->unsur_warna->OldValue = $this->unsur_warna->CurrentValue;
    ...
    protected function newRow()
    {
        ...
        $row['akta_pendirian'] = $this->akta_pendirian->CurrentValue;
        $row['surat_umk'] = $this->surat_umk->CurrentValue;
        $row['ttd_pemohon'] = $this->ttd_pemohon->CurrentValue;
        $row['nama_merk'] = $this->nama_merk->CurrentValue;
        $row['label_merk'] = $this->label_merk->CurrentValue;
        $row['label_deskripsi'] = $this->label_deskripsi->CurrentValue;
        $row['unsur_warna'] = $this->unsur_warna->CurrentValue;
    ...
    protected function addRow($rsold = null)
    {
        ...
        // akta_pendirian
        $this->akta_pendirian->setDbValueDef($rsnew, $this->akta_pendirian->CurrentValue, null, false);

        // surat_umk
        $this->surat_umk->setDbValueDef($rsnew, $this->surat_umk->CurrentValue, null, false);

        // ttd_pemohon
        $this->ttd_pemohon->setDbValueDef($rsnew, $this->ttd_pemohon->CurrentValue, null, false);

        // nama_merk
        $this->nama_merk->setDbValueDef($rsnew, $this->nama_merk->CurrentValue, null, false);

        // label_merk
        $this->label_merk->setDbValueDef($rsnew, $this->label_merk->CurrentValue, null, false);

        // label_deskripsi
        $this->label_deskripsi->setDbValueDef($rsnew, $this->label_deskripsi->CurrentValue, null, false);

        // unsur_warna
        $this->unsur_warna->setDbValueDef($rsnew, $this->unsur_warna->CurrentValue, null, false);
