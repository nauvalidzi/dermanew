...
class NpdList extends Npd
{
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->kodeorder, $ctrl); // kodeorder
            $this->updateSort($this->idbrand, $ctrl); // idbrand
            $this->updateSort($this->nama, $ctrl); // nama
            $this->updateSort($this->idproduct_acuan, $ctrl); // idproduct_acuan
    ...
    public function pageDataRendered(&$footer)
    {
        ...
        function selesai(id) {
    		$.get('".domain()."/api/npd/selesai/'+id, function(data) {
    			if (data == 1) {
    				location.reload();
    			} else {
        ...
        function belumselesai(id) {
    		$.get('".domain()."/api/npd/belumselesai/'+id, function(data) {
    			if (data == 1) {
    				location.reload();
    			} else {
