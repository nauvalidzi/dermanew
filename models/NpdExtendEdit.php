 ...
 * Page class
 */
class NpdExtendEdit extends NpdExtend
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "NpdExtendEdit";
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // tglbayar
            $this->tglbayar->setDbValueDef($rsnew, UnFormatDateTime($this->tglbayar->CurrentValue, 0), CurrentDate(), $this->tglbayar->ReadOnly);

            // buktipembayaran
            $this->buktipembayaran->setDbValueDef($rsnew, $this->buktipembayaran->CurrentValue, null, $this->buktipembayaran->ReadOnly);
