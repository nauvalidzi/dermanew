...
class IjinhakiStatusPreview extends IjinhakiStatus
{
    ...
    protected function setupSortOrder()
    {
        ...
        if ($this->CurrentOrder !== "") {
            ...
            $this->updateSort($this->targetmulai, $ctrl); // targetmulai
            $this->updateSort($this->tglmulai, $ctrl); // tglmulai
            $this->updateSort($this->targetselesai, $ctrl); // targetselesai
            $this->updateSort($this->tglselesai, $ctrl); // tglselesai
