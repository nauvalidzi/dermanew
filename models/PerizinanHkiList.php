 ...
 * Page class
 */
class PerizinanHkiList extends PerizinanHki
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PerizinanHkiList";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fperizinan_hkilist";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "PerizinanHkiAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "PerizinanHkiDelete";
        $this->MultiUpdateUrl = "PerizinanHkiUpdate";
        ...
        $this->FilterOptions->TagClassName = "ew-filter-option fperizinan_hkilistsrch";
    ...
    public function run()
    {
        ...
        $this->label_deskripsi->Visible = false;
        $this->unsur_warna->Visible = false;
    ...
    public function getFilterList()
    {
        ...
        $filterList = Concat($filterList, $this->surat_umk->AdvancedSearch->toJson(), ","); // Field surat_umk
        $filterList = Concat($filterList, $this->ttd_pemohon->AdvancedSearch->toJson(), ","); // Field ttd_pemohon
        $filterList = Concat($filterList, $this->nama_merk->AdvancedSearch->toJson(), ","); // Field nama_merk
        $filterList = Concat($filterList, $this->label_merk->AdvancedSearch->toJson(), ","); // Field label_merk
        $filterList = Concat($filterList, $this->label_deskripsi->AdvancedSearch->toJson(), ","); // Field label_deskripsi
        $filterList = Concat($filterList, $this->unsur_warna->AdvancedSearch->toJson(), ","); // Field unsur_warna
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "fperizinan_hkilistsrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field surat_umk
        $this->surat_umk->AdvancedSearch->SearchValue = @$filter["x_surat_umk"];
        $this->surat_umk->AdvancedSearch->SearchOperator = @$filter["z_surat_umk"];
        $this->surat_umk->AdvancedSearch->SearchCondition = @$filter["v_surat_umk"];
        $this->surat_umk->AdvancedSearch->SearchValue2 = @$filter["y_surat_umk"];
        $this->surat_umk->AdvancedSearch->SearchOperator2 = @$filter["w_surat_umk"];
        $this->surat_umk->AdvancedSearch->save();
        ...
        // Field nama_merk
        $this->nama_merk->AdvancedSearch->SearchValue = @$filter["x_nama_merk"];
        $this->nama_merk->AdvancedSearch->SearchOperator = @$filter["z_nama_merk"];
        $this->nama_merk->AdvancedSearch->SearchCondition = @$filter["v_nama_merk"];
        $this->nama_merk->AdvancedSearch->SearchValue2 = @$filter["y_nama_merk"];
        $this->nama_merk->AdvancedSearch->SearchOperator2 = @$filter["w_nama_merk"];
        $this->nama_merk->AdvancedSearch->save();

        // Field label_merk
        $this->label_merk->AdvancedSearch->SearchValue = @$filter["x_label_merk"];
        $this->label_merk->AdvancedSearch->SearchOperator = @$filter["z_label_merk"];
        $this->label_merk->AdvancedSearch->SearchCondition = @$filter["v_label_merk"];
        $this->label_merk->AdvancedSearch->SearchValue2 = @$filter["y_label_merk"];
        $this->label_merk->AdvancedSearch->SearchOperator2 = @$filter["w_label_merk"];
        $this->label_merk->AdvancedSearch->save();

        // Field label_deskripsi
        $this->label_deskripsi->AdvancedSearch->SearchValue = @$filter["x_label_deskripsi"];
        $this->label_deskripsi->AdvancedSearch->SearchOperator = @$filter["z_label_deskripsi"];
        $this->label_deskripsi->AdvancedSearch->SearchCondition = @$filter["v_label_deskripsi"];
        $this->label_deskripsi->AdvancedSearch->SearchValue2 = @$filter["y_label_deskripsi"];
        $this->label_deskripsi->AdvancedSearch->SearchOperator2 = @$filter["w_label_deskripsi"];
        $this->label_deskripsi->AdvancedSearch->save();

        // Field unsur_warna
        $this->unsur_warna->AdvancedSearch->SearchValue = @$filter["x_unsur_warna"];
        $this->unsur_warna->AdvancedSearch->SearchOperator = @$filter["z_unsur_warna"];
        $this->unsur_warna->AdvancedSearch->SearchCondition = @$filter["v_unsur_warna"];
        $this->unsur_warna->AdvancedSearch->SearchValue2 = @$filter["y_unsur_warna"];
        $this->unsur_warna->AdvancedSearch->SearchOperator2 = @$filter["w_unsur_warna"];
        $this->unsur_warna->AdvancedSearch->save();
    ...
    protected function basicSearchSql($arKeywords, $type)
    {
        ...
        $this->buildBasicSearchSql($where, $this->surat_umk, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->ttd_pemohon, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->nama_merk, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->label_merk, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->label_deskripsi, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->unsur_warna, $arKeywords, $type);
        return $where;
    }
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->no_order, $ctrl); // no_order
            $this->updateSort($this->idpegawai, $ctrl); // idpegawai
            $this->updateSort($this->idcustomer, $ctrl); // idcustomer
            $this->updateSort($this->tanggal_terima, $ctrl); // tanggal_terima
            $this->updateSort($this->tanggal_submit, $ctrl); // tanggal_submit
            $this->updateSort($this->ktp, $ctrl); // ktp
            $this->updateSort($this->npwp, $ctrl); // npwp
            $this->updateSort($this->nib, $ctrl); // nib
            $this->updateSort($this->akta_pendirian, $ctrl); // akta_pendirian
            $this->updateSort($this->surat_umk, $ctrl); // surat_umk
            $this->updateSort($this->ttd_pemohon, $ctrl); // ttd_pemohon
            $this->updateSort($this->nama_merk, $ctrl); // nama_merk
            $this->updateSort($this->label_merk, $ctrl); // label_merk
            $this->updateSort($this->created_at, $ctrl); // created_at
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->surat_umk->setSort("");
                $this->ttd_pemohon->setSort("");
                $this->nama_merk->setSort("");
                $this->label_merk->setSort("");
                $this->label_deskripsi->setSort("");
                $this->unsur_warna->setSort("");
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fperizinan_hkilistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fperizinan_hkilistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<a class="ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" href="#" onclick="return ew.submitAction(event,jQuery.extend({f:document.fperizinan_hkilist},' . $listaction->toJson(true) . '));">' . $icon . '</a>';
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fperizinan_hkilistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
