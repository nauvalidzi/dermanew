...
class ProductSearch extends Product
{
    ...
    protected function buildAdvancedSearch()
    {
        ...
        $this->buildSearchUrl($srchUrl, $this->idkemasanbarang); // idkemasanbarang
    ...
    protected function loadSearchValues()
    {
        ...
        if ($this->idkemasanbarang->AdvancedSearch->post()) {
            $hasValue = true;
        }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $curVal = trim(strval($this->idkemasanbarang->AdvancedSearch->SearchValue));
            if ($curVal != "") {
                $this->idkemasanbarang->AdvancedSearch->ViewValue = $this->idkemasanbarang->lookupCacheOption($curVal);
            } else {
                $this->idkemasanbarang->AdvancedSearch->ViewValue = $this->idkemasanbarang->Lookup !== null && is_array($this->idkemasanbarang->Lookup->Options) ? $curVal : null;
            }
            if ($this->idkemasanbarang->AdvancedSearch->ViewValue !== null) { // Load from cache
                $this->idkemasanbarang->EditValue = array_values($this->idkemasanbarang->Lookup->Options);
            } else { // Lookup from database
                if ($curVal == "") {
                    $filterWrk = "0=1";
                } else {
                    $filterWrk = "`id`" . SearchString("=", $this->idkemasanbarang->AdvancedSearch->SearchValue, DATATYPE_NUMBER, "");
                }
