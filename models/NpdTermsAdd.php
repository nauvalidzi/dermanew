...
class NpdTermsAdd extends NpdTerms
{
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->sifatorder->CurrentValue = 0;
        $this->ukuranutama->CurrentValue = null;
        $this->ukuranutama->OldValue = $this->ukuranutama->CurrentValue;
        $this->utamahargaisipcs->CurrentValue = null;
        $this->utamahargaisipcs->OldValue = $this->utamahargaisipcs->CurrentValue;
        $this->utamahargaprimerpcs->CurrentValue = null;
        $this->utamahargaprimerpcs->OldValue = $this->utamahargaprimerpcs->CurrentValue;
        $this->utamahargasekunderpcs->CurrentValue = null;
        $this->utamahargasekunderpcs->OldValue = $this->utamahargasekunderpcs->CurrentValue;
        $this->utamahargalabelpcs->CurrentValue = null;
        $this->utamahargalabelpcs->OldValue = $this->utamahargalabelpcs->CurrentValue;
        $this->utamahargatotalpcs->CurrentValue = null;
        $this->utamahargatotalpcs->OldValue = $this->utamahargatotalpcs->CurrentValue;
        $this->utamahargaisiorder->CurrentValue = null;
        $this->utamahargaisiorder->OldValue = $this->utamahargaisiorder->CurrentValue;
        $this->utamahargaprimerorder->CurrentValue = null;
        $this->utamahargaprimerorder->OldValue = $this->utamahargaprimerorder->CurrentValue;
        $this->utamahargasekunderorder->CurrentValue = null;
        $this->utamahargasekunderorder->OldValue = $this->utamahargasekunderorder->CurrentValue;
        $this->utamahargalabelorder->CurrentValue = null;
        $this->utamahargalabelorder->OldValue = $this->utamahargalabelorder->CurrentValue;
        $this->utamahargatotalorder->CurrentValue = null;
        $this->utamahargatotalorder->OldValue = $this->utamahargatotalorder->CurrentValue;
        $this->ukuranlain->CurrentValue = null;
        $this->ukuranlain->OldValue = $this->ukuranlain->CurrentValue;
        $this->lainhargaisipcs->CurrentValue = null;
        $this->lainhargaisipcs->OldValue = $this->lainhargaisipcs->CurrentValue;
        $this->lainhargaprimerpcs->CurrentValue = null;
        $this->lainhargaprimerpcs->OldValue = $this->lainhargaprimerpcs->CurrentValue;
        $this->lainhargasekunderpcs->CurrentValue = null;
        $this->lainhargasekunderpcs->OldValue = $this->lainhargasekunderpcs->CurrentValue;
        $this->lainhargalabelpcs->CurrentValue = null;
        $this->lainhargalabelpcs->OldValue = $this->lainhargalabelpcs->CurrentValue;
        $this->lainhargatotalpcs->CurrentValue = null;
        $this->lainhargatotalpcs->OldValue = $this->lainhargatotalpcs->CurrentValue;
        $this->lainhargaisiorder->CurrentValue = null;
        $this->lainhargaisiorder->OldValue = $this->lainhargaisiorder->CurrentValue;
        $this->lainhargaprimerorder->CurrentValue = null;
        $this->lainhargaprimerorder->OldValue = $this->lainhargaprimerorder->CurrentValue;
        $this->lainhargasekunderorder->CurrentValue = null;
        $this->lainhargasekunderorder->OldValue = $this->lainhargasekunderorder->CurrentValue;
        $this->lainhargalabelorder->CurrentValue = null;
        $this->lainhargalabelorder->OldValue = $this->lainhargalabelorder->CurrentValue;
        $this->lainhargatotalorder->CurrentValue = null;
        $this->lainhargatotalorder->OldValue = $this->lainhargatotalorder->CurrentValue;
        $this->isibahanaktif->CurrentValue = null;
        $this->isibahanaktif->OldValue = $this->isibahanaktif->CurrentValue;
        $this->isibahanlain->CurrentValue = null;
        $this->isibahanlain->OldValue = $this->isibahanlain->CurrentValue;
        $this->isiparfum->CurrentValue = null;
        $this->isiparfum->OldValue = $this->isiparfum->CurrentValue;
        $this->isiestetika->CurrentValue = null;
        $this->isiestetika->OldValue = $this->isiestetika->CurrentValue;
        ...
        $this->kemasansekunder->CurrentValue = null;
        $this->kemasansekunder->OldValue = $this->kemasansekunder->CurrentValue;
        $this->desainlabel->CurrentValue = null;
        $this->desainlabel->OldValue = $this->desainlabel->CurrentValue;
        $this->cetaklabel->CurrentValue = null;
        $this->cetaklabel->OldValue = $this->cetaklabel->CurrentValue;
        $this->lainlain->CurrentValue = null;
        $this->lainlain->OldValue = $this->lainlain->CurrentValue;
        $this->deliverypickup->CurrentValue = null;
        $this->deliverypickup->OldValue = $this->deliverypickup->CurrentValue;
        $this->deliverysinglepoint->CurrentValue = null;
        $this->deliverysinglepoint->OldValue = $this->deliverysinglepoint->CurrentValue;
        $this->deliverymultipoint->CurrentValue = null;
        $this->deliverymultipoint->OldValue = $this->deliverymultipoint->CurrentValue;
        $this->deliveryjumlahpoint->CurrentValue = null;
        $this->deliveryjumlahpoint->OldValue = $this->deliveryjumlahpoint->CurrentValue;
        $this->deliverytermslain->CurrentValue = null;
        $this->deliverytermslain->OldValue = $this->deliverytermslain->CurrentValue;
        $this->catatankhusus->CurrentValue = null;
        $this->catatankhusus->OldValue = $this->catatankhusus->CurrentValue;
    ...
    protected function newRow()
    {
        ...
        $row['ukuranutama'] = $this->ukuranutama->CurrentValue;
        $row['utamahargaisipcs'] = $this->utamahargaisipcs->CurrentValue;
        $row['utamahargaprimerpcs'] = $this->utamahargaprimerpcs->CurrentValue;
        $row['utamahargasekunderpcs'] = $this->utamahargasekunderpcs->CurrentValue;
        $row['utamahargalabelpcs'] = $this->utamahargalabelpcs->CurrentValue;
        $row['utamahargatotalpcs'] = $this->utamahargatotalpcs->CurrentValue;
        $row['utamahargaisiorder'] = $this->utamahargaisiorder->CurrentValue;
        $row['utamahargaprimerorder'] = $this->utamahargaprimerorder->CurrentValue;
        $row['utamahargasekunderorder'] = $this->utamahargasekunderorder->CurrentValue;
        $row['utamahargalabelorder'] = $this->utamahargalabelorder->CurrentValue;
        $row['utamahargatotalorder'] = $this->utamahargatotalorder->CurrentValue;
        $row['ukuranlain'] = $this->ukuranlain->CurrentValue;
        $row['lainhargaisipcs'] = $this->lainhargaisipcs->CurrentValue;
        $row['lainhargaprimerpcs'] = $this->lainhargaprimerpcs->CurrentValue;
        $row['lainhargasekunderpcs'] = $this->lainhargasekunderpcs->CurrentValue;
        $row['lainhargalabelpcs'] = $this->lainhargalabelpcs->CurrentValue;
        $row['lainhargatotalpcs'] = $this->lainhargatotalpcs->CurrentValue;
        $row['lainhargaisiorder'] = $this->lainhargaisiorder->CurrentValue;
        $row['lainhargaprimerorder'] = $this->lainhargaprimerorder->CurrentValue;
        $row['lainhargasekunderorder'] = $this->lainhargasekunderorder->CurrentValue;
        $row['lainhargalabelorder'] = $this->lainhargalabelorder->CurrentValue;
        $row['lainhargatotalorder'] = $this->lainhargatotalorder->CurrentValue;
        $row['isibahanaktif'] = $this->isibahanaktif->CurrentValue;
        $row['isibahanlain'] = $this->isibahanlain->CurrentValue;
        $row['isiparfum'] = $this->isiparfum->CurrentValue;
        $row['isiestetika'] = $this->isiestetika->CurrentValue;
        $row['kemasanwadah'] = $this->kemasanwadah->CurrentValue;
        $row['kemasantutup'] = $this->kemasantutup->CurrentValue;
        $row['kemasansekunder'] = $this->kemasansekunder->CurrentValue;
        $row['desainlabel'] = $this->desainlabel->CurrentValue;
        $row['cetaklabel'] = $this->cetaklabel->CurrentValue;
        $row['lainlain'] = $this->lainlain->CurrentValue;
        $row['deliverypickup'] = $this->deliverypickup->CurrentValue;
        $row['deliverysinglepoint'] = $this->deliverysinglepoint->CurrentValue;
        $row['deliverymultipoint'] = $this->deliverymultipoint->CurrentValue;
        $row['deliveryjumlahpoint'] = $this->deliveryjumlahpoint->CurrentValue;
        $row['deliverytermslain'] = $this->deliverytermslain->CurrentValue;
        $row['catatankhusus'] = $this->catatankhusus->CurrentValue;
    ...
    protected function addRow($rsold = null)
    {
        ...
        $this->sifatorder->setDbValueDef($rsnew, $tmpBool, 0, strval($this->sifatorder->CurrentValue) == "");

        // ukuranutama
        $this->ukuranutama->setDbValueDef($rsnew, $this->ukuranutama->CurrentValue, null, false);

        // utamahargaisipcs
        $this->utamahargaisipcs->setDbValueDef($rsnew, $this->utamahargaisipcs->CurrentValue, null, false);

        // utamahargaprimerpcs
        $this->utamahargaprimerpcs->setDbValueDef($rsnew, $this->utamahargaprimerpcs->CurrentValue, null, false);

        // utamahargasekunderpcs
        $this->utamahargasekunderpcs->setDbValueDef($rsnew, $this->utamahargasekunderpcs->CurrentValue, null, false);

        // utamahargalabelpcs
        $this->utamahargalabelpcs->setDbValueDef($rsnew, $this->utamahargalabelpcs->CurrentValue, null, false);

        // utamahargatotalpcs
        $this->utamahargatotalpcs->setDbValueDef($rsnew, $this->utamahargatotalpcs->CurrentValue, null, false);

        // utamahargaisiorder
        $this->utamahargaisiorder->setDbValueDef($rsnew, $this->utamahargaisiorder->CurrentValue, null, false);

        // utamahargaprimerorder
        $this->utamahargaprimerorder->setDbValueDef($rsnew, $this->utamahargaprimerorder->CurrentValue, null, false);

        // utamahargasekunderorder
        $this->utamahargasekunderorder->setDbValueDef($rsnew, $this->utamahargasekunderorder->CurrentValue, null, false);

        // utamahargalabelorder
        $this->utamahargalabelorder->setDbValueDef($rsnew, $this->utamahargalabelorder->CurrentValue, null, false);

        // utamahargatotalorder
        $this->utamahargatotalorder->setDbValueDef($rsnew, $this->utamahargatotalorder->CurrentValue, null, false);

        // ukuranlain
        $this->ukuranlain->setDbValueDef($rsnew, $this->ukuranlain->CurrentValue, null, false);

        // lainhargaisipcs
        $this->lainhargaisipcs->setDbValueDef($rsnew, $this->lainhargaisipcs->CurrentValue, null, false);

        // lainhargaprimerpcs
        $this->lainhargaprimerpcs->setDbValueDef($rsnew, $this->lainhargaprimerpcs->CurrentValue, null, false);

        // lainhargasekunderpcs
        $this->lainhargasekunderpcs->setDbValueDef($rsnew, $this->lainhargasekunderpcs->CurrentValue, null, false);

        // lainhargalabelpcs
        $this->lainhargalabelpcs->setDbValueDef($rsnew, $this->lainhargalabelpcs->CurrentValue, null, false);

        // lainhargatotalpcs
        $this->lainhargatotalpcs->setDbValueDef($rsnew, $this->lainhargatotalpcs->CurrentValue, null, false);

        // lainhargaisiorder
        $this->lainhargaisiorder->setDbValueDef($rsnew, $this->lainhargaisiorder->CurrentValue, null, false);

        // lainhargaprimerorder
        $this->lainhargaprimerorder->setDbValueDef($rsnew, $this->lainhargaprimerorder->CurrentValue, null, false);

        // lainhargasekunderorder
        $this->lainhargasekunderorder->setDbValueDef($rsnew, $this->lainhargasekunderorder->CurrentValue, null, false);

        // lainhargalabelorder
        $this->lainhargalabelorder->setDbValueDef($rsnew, $this->lainhargalabelorder->CurrentValue, null, false);

        // lainhargatotalorder
        $this->lainhargatotalorder->setDbValueDef($rsnew, $this->lainhargatotalorder->CurrentValue, null, false);

        // isibahanaktif
        $this->isibahanaktif->setDbValueDef($rsnew, $this->isibahanaktif->CurrentValue, null, false);

        // isibahanlain
        $this->isibahanlain->setDbValueDef($rsnew, $this->isibahanlain->CurrentValue, null, false);

        // isiparfum
        $this->isiparfum->setDbValueDef($rsnew, $this->isiparfum->CurrentValue, null, false);

        // isiestetika
        $this->isiestetika->setDbValueDef($rsnew, $this->isiestetika->CurrentValue, null, false);
        ...
        // kemasansekunder
        $this->kemasansekunder->setDbValueDef($rsnew, $this->kemasansekunder->CurrentValue, null, false);

        // desainlabel
        $this->desainlabel->setDbValueDef($rsnew, $this->desainlabel->CurrentValue, null, false);

        // cetaklabel
        $this->cetaklabel->setDbValueDef($rsnew, $this->cetaklabel->CurrentValue, null, false);

        // lainlain
        $this->lainlain->setDbValueDef($rsnew, $this->lainlain->CurrentValue, null, false);

        // deliverypickup
        $this->deliverypickup->setDbValueDef($rsnew, $this->deliverypickup->CurrentValue, null, false);

        // deliverysinglepoint
        $this->deliverysinglepoint->setDbValueDef($rsnew, $this->deliverysinglepoint->CurrentValue, null, false);

        // deliverymultipoint
        $this->deliverymultipoint->setDbValueDef($rsnew, $this->deliverymultipoint->CurrentValue, null, false);

        // deliveryjumlahpoint
        $this->deliveryjumlahpoint->setDbValueDef($rsnew, $this->deliveryjumlahpoint->CurrentValue, null, false);

        // deliverytermslain
        $this->deliverytermslain->setDbValueDef($rsnew, $this->deliverytermslain->CurrentValue, null, false);

        // catatankhusus
        $this->catatankhusus->setDbValueDef($rsnew, $this->catatankhusus->CurrentValue, null, false);
