...
class NpdSerahterimaList extends NpdSerahterima
{
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->tanggal_request, $ctrl); // tanggal_request
            $this->updateSort($this->tanggal_serahterima, $ctrl); // tanggal_serahterima
            $this->updateSort($this->jenis_produk, $ctrl); // jenis_produk
