...
class DJatuhtempoList extends DJatuhtempo
{
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->namapegawai, $ctrl); // namapegawai
            $this->updateSort($this->idcustomer, $ctrl); // idcustomer
            $this->updateSort($this->namacustomer, $ctrl); // namacustomer
            $this->updateSort($this->idinvoice, $ctrl); // idinvoice
            $this->updateSort($this->kodeinvoice, $ctrl); // kodeinvoice
            $this->updateSort($this->sisabayar, $ctrl); // sisabayar
            $this->updateSort($this->jatuhtempo, $ctrl); // jatuhtempo
            $this->updateSort($this->sisahari, $ctrl); // sisahari
