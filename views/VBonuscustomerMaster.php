...
<table id="tbl_v_bonuscustomermaster" class="table ew-view-table ew-master-table ew-vertical">
    <tbody>
<?php if ($v_bonuscustomer->idpegawai->Visible) { // idpegawai ?>
        <tr id="r_idpegawai">
            <td class="<?= $v_bonuscustomer->TableLeftColumnClass ?>"><?= $v_bonuscustomer->idpegawai->caption() ?></td>
            <td <?= $v_bonuscustomer->idpegawai->cellAttributes() ?>>
<span id="el_v_bonuscustomer_idpegawai">
<span<?= $v_bonuscustomer->idpegawai->viewAttributes() ?>>
<?= $v_bonuscustomer->idpegawai->getViewValue() ?></span>
</span>
</td>
        </tr>
<?php } ?>
