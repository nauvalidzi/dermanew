...
<?php if ($Page->tglreview->Visible) { // tglreview ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->tglreview->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?= HtmlEncode($Page->tglreview->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->tglreview->getNextSort() ?>">
