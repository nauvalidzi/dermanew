...
<?php if ($Page->namaalt->Visible) { // namaalt ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->namaalt->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?= HtmlEncode($Page->namaalt->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->namaalt->getNextSort() ?>">
...
<?php if ($Page->idproduct_acuan->Visible) { // idproduct_acuan ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->idproduct_acuan->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?= HtmlEncode($Page->idproduct_acuan->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->idproduct_acuan->getNextSort() ?>">
...
<?php if ($Page->kodesample->Visible) { // kodesample ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->kodesample->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?= HtmlEncode($Page->kodesample->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->kodesample->getNextSort() ?>">
