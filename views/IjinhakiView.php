...
<?php if ($Page->buktibayar->Visible) { // buktibayar ?>
    <tr id="r_buktibayar">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ijinhaki_buktibayar"><?= $Page->buktibayar->caption() ?></span></td>
        <td data-name="buktibayar" <?= $Page->buktibayar->cellAttributes() ?>>
<span id="el_ijinhaki_buktibayar">
<span>
<?= GetFileViewTag($Page->buktibayar, $Page->buktibayar->getViewValue(), false) ?>
</span>
</span>
</td>
    </tr>
