...
<?php if ($Page->tglpengajuan->Visible) { // tglpengajuan ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->tglpengajuan->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?= HtmlEncode($Page->tglpengajuan->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->tglpengajuan->getNextSort() ?>">
...
<?php if ($Page->idnpd_sample->Visible) { // idnpd_sample ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->idnpd_sample->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?= HtmlEncode($Page->idnpd_sample->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->idnpd_sample->getNextSort() ?>">
...
<?php if ($Page->idaplikasibarang->Visible) { // idaplikasibarang ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->idaplikasibarang->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?= HtmlEncode($Page->idaplikasibarang->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->idaplikasibarang->getNextSort() ?>">
...
<?php if ($Page->hargapcs->Visible) { // hargapcs ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->hargapcs->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?= HtmlEncode($Page->hargapcs->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->hargapcs->getNextSort() ?>">
...
<?php if ($Page->disetujui->Visible) { // disetujui ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->disetujui->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?= HtmlEncode($Page->disetujui->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->disetujui->getNextSort() ?>">
