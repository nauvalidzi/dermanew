...
<?php if ($Page->selesai->Visible) { // selesai ?>
        <th class="<?= $Page->selesai->headerCellClass() ?>"><span id="elh_ijinbpom_selesai" class="ijinbpom_selesai"><?= $Page->selesai->caption() ?></span></th>
<?php } ?>
    </tr>
    </thead>
    <tbody>
...
<span id="el<?= $Page->RowCount ?>_ijinbpom_selesai" class="ijinbpom_selesai">
