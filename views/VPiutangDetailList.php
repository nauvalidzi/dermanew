...
<?php if ($Page->idcustomer->Visible) { // idcustomer ?>
        <th data-name="idcustomer" class="<?= $Page->idcustomer->headerCellClass() ?>"><div id="elh_v_piutang_detail_idcustomer" class="v_piutang_detail_idcustomer"><?= $Page->renderSort($Page->idcustomer) ?></div></th>
<?php } ?>
...
<span id="el<?= $Page->RowCount ?>_v_piutang_detail_idcustomer">
