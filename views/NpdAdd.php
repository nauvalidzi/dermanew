...
loadjs.ready("head", function () {
    ...
    fnpdadd.lists.idkemasanbarang = <?= $Page->idkemasanbarang->toClientList($Page) ?>;
    loadjs.done("fnpdadd");
});
</script>
<script>
...
<input type="<?= $Page->label->getInputTextType() ?>" data-table="npd" data-field="x_label" data-page="1" name="x_label" id="x_label" size="30" maxlength="100" placeholder="<?= HtmlEncode($Page->label->getPlaceHolder()) ?>" value="<?= $Page->label->EditValue ?>"<?= $Page->label->editAttributes() ?> aria-describedby="x_label_help">
...
loadjs.ready("load", function () {
    // Startup script
    loadjs.ready("jquery",(function(){$("#x_idcustomer").change((function(){$.get("<?php echo domain(); ?>/api/nextKodeNpd/"+$(this).val(),(function(e){$("#x_kodeorder").val(e)}))}))}));
});
</script>
