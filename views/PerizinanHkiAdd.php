...
// Page object
$PerizinanHkiAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fperizinan_hkiadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fperizinan_hkiadd = currentForm = new ew.Form("fperizinan_hkiadd", "add");
    ...
    // Validate form
    fperizinan_hkiadd.validate = function () {
    ...
    // Form_CustomValidate
    fperizinan_hkiadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fperizinan_hkiadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fperizinan_hkiadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fperizinan_hkiadd" id="fperizinan_hkiadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["fperizinan_hkiadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fperizinan_hkiadd", "x_tanggal_terima", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fperizinan_hkiadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fperizinan_hkiadd", "x_tanggal_submit", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fperizinan_hkiadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fperizinan_hkiadd", "x_created_at", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
