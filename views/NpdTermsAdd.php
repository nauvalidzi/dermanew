...
loadjs.ready("head", function () {
    ...
    fnpd_termsadd.lists.sifatorder = <?= $Page->sifatorder->toClientList($Page) ?>;
...
<script>
loadjs.ready(["fnpd_termsadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fnpd_termsadd", "x_tanggal", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
