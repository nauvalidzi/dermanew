...
loadjs.ready("head", function () {
    ...
    fproductedit.lists.idkemasanbarang = <?= $Page->idkemasanbarang->toClientList($Page) ?>;
...
<?php if ($Page->idkemasanbarang->Visible) { // idkemasanbarang ?>
    <div id="r_idkemasanbarang" class="form-group row">
        <label id="elh_product_idkemasanbarang" for="x_idkemasanbarang" class="<?= $Page->LeftColumnClass ?>"><?= $Page->idkemasanbarang->caption() ?><?= $Page->idkemasanbarang->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->idkemasanbarang->cellAttributes() ?>>
<span id="el_product_idkemasanbarang">
    <select
