...
<?php if ($Page->idnpd->Visible) { // idnpd ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->idnpd->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?= HtmlEncode($Page->idnpd->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->idnpd->getNextSort() ?>">
...
<?php if ($Page->kode->Visible) { // kode ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->kode->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?= HtmlEncode($Page->kode->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->kode->getNextSort() ?>">
...
<?php if ($Page->nama->Visible) { // nama ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->nama->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?= HtmlEncode($Page->nama->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->nama->getNextSort() ?>">
...
<?php if ($Page->sediaan->Visible) { // sediaan ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->sediaan->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?= HtmlEncode($Page->sediaan->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->sediaan->getNextSort() ?>">
...
<?php if ($Page->ukuran->Visible) { // ukuran ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->ukuran->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?= HtmlEncode($Page->ukuran->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->ukuran->getNextSort() ?>">
...
<?php if ($Page->warna->Visible) { // warna ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->warna->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?= HtmlEncode($Page->warna->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->warna->getNextSort() ?>">
...
<?php if ($Page->bau->Visible) { // bau ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->bau->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?= HtmlEncode($Page->bau->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->bau->getNextSort() ?>">
...
<?php if ($Page->fungsi->Visible) { // fungsi ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->fungsi->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?= HtmlEncode($Page->fungsi->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->fungsi->getNextSort() ?>">
