...
<?php if ($Page->id->Visible) { // id ?>
        <th class="<?= $Page->id->headerCellClass() ?>"><span id="elh_rekening_id" class="rekening_id"><?= $Page->id->caption() ?></span></th>
<?php } ?>
...
<span id="el<?= $Page->RowCount ?>_rekening_id" class="rekening_id">
