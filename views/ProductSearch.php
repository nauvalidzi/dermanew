...
loadjs.ready("head", function () {
    ...
    fproductsearch.addFields([
        ...
        ["idkemasanbarang", [], fields.idkemasanbarang.isInvalid],
    ...
    fproductsearch.lists.idkemasanbarang = <?= $Page->idkemasanbarang->toClientList($Page) ?>;
...
<?php if ($Page->idkemasanbarang->Visible) { // idkemasanbarang ?>
    <div id="r_idkemasanbarang" class="form-group row">
        <label for="x_idkemasanbarang" class="<?= $Page->LeftColumnClass ?>"><span id="elh_product_idkemasanbarang"><?= $Page->idkemasanbarang->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
<input type="hidden" name="z_idkemasanbarang" id="z_idkemasanbarang" value="=">
</span>
        </label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->idkemasanbarang->cellAttributes() ?>>
            <span id="el_product_idkemasanbarang" class="ew-search-field ew-search-field-single">
    <select
        id="x_idkemasanbarang"
        name="x_idkemasanbarang"
        class="form-control ew-select<?= $Page->idkemasanbarang->isInvalidClass() ?>"
        data-select2-id="product_x_idkemasanbarang"
        data-table="product"
    ...
    <div class="invalid-feedback"><?= $Page->idkemasanbarang->getErrorMessage(false) ?></div>
<?= $Page->idkemasanbarang->Lookup->getParamTag($Page, "p_x_idkemasanbarang") ?>
<script>
loadjs.ready("head", function() {
    var el = document.querySelector("select[data-select2-id='product_x_idkemasanbarang']"),
        options = { name: "x_idkemasanbarang", selectId: "product_x_idkemasanbarang", language: ew.LANGUAGE_ID, dir: ew.IS_RTL ? "rtl" : "ltr" };
    options.dropdownParent = $(el).closest("#ew-modal-dialog, #ew-add-opt-dialog")[0];
