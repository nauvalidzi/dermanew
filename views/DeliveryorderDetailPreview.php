...
<?php if ($Page->idorder->Visible) { // idorder ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->idorder->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?= HtmlEncode($Page->idorder->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->idorder->getNextSort() ?>">
