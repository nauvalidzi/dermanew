...
<?php } ?>
    ...
    <?php if (strval($Page->idserahterima->getSessionValue()) != "") { ?>
    <input type="hidden" name="x_idserahterima" id="x_idserahterima" value="<?= HtmlEncode(strval($Page->idserahterima->getSessionValue())) ?>">
    <?php } ?>
<?php if (!$Page->IsModal) { ?>
