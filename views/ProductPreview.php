...
<?php if ($Page->idkemasanbarang->Visible) { // idkemasanbarang ?>
    <?php if ($Page->SortUrl($Page->idkemasanbarang) == "") { ?>
        <th class="<?= $Page->idkemasanbarang->headerCellClass() ?>"><?= $Page->idkemasanbarang->caption() ?></th>
    <?php } else { ?>
        <th class="<?= $Page->idkemasanbarang->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?= HtmlEncode($Page->idkemasanbarang->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->idkemasanbarang->getNextSort() ?>">
            <div class="ew-table-header-btn"><span class="ew-table-header-caption"><?= $Page->idkemasanbarang->caption() ?></span><span class="ew-table-header-sort"><?php if ($Page->idkemasanbarang->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($Page->idkemasanbarang->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span>
        </div></div></th>
    <?php } ?>
<?php } ?>
...
<?php if ($Page->idkemasanbarang->Visible) { // idkemasanbarang ?>
        <!-- idkemasanbarang -->
        <td<?= $Page->idkemasanbarang->cellAttributes() ?>>
<span<?= $Page->idkemasanbarang->viewAttributes() ?>>
<?= $Page->idkemasanbarang->getViewValue() ?></span>
</td>
<?php } ?>
<?php if ($Page->harga->Visible) { // harga ?>
        <!-- harga -->
