...
<?php if ($Page->idcustomer->Visible) { // idcustomer ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->idcustomer->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?= HtmlEncode($Page->idcustomer->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->idcustomer->getNextSort() ?>">
...
<?php if ($Page->idinvoice->Visible) { // idinvoice ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->idinvoice->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?= HtmlEncode($Page->idinvoice->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->idinvoice->getNextSort() ?>">
...
<?php if ($Page->sisabayar->Visible) { // sisabayar ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->sisabayar->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?= HtmlEncode($Page->sisabayar->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->sisabayar->getNextSort() ?>">
...
<?php if ($Page->tglinvoice->Visible) { // tglinvoice ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->tglinvoice->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?= HtmlEncode($Page->tglinvoice->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->tglinvoice->getNextSort() ?>">
...
<?php if ($Page->jatuhtempo->Visible) { // jatuhtempo ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->jatuhtempo->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?= HtmlEncode($Page->jatuhtempo->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->jatuhtempo->getNextSort() ?>">
