...
<?php if ($Grid->idcustomer->Visible) { // idcustomer ?>
        <th data-name="idcustomer" class="<?= $Grid->idcustomer->headerCellClass() ?>"><div id="elh_v_piutang_detail_idcustomer" class="v_piutang_detail_idcustomer"><?= $Grid->renderSort($Grid->idcustomer) ?></div></th>
<?php } ?>
...
<span id="el<?= $Grid->RowCount ?>_v_piutang_detail_idcustomer" class="form-group">
...
<?php } else { ?>
<span id="el<?= $Grid->RowCount ?>_v_piutang_detail_idcustomer" class="form-group">
<input type="<?= $Grid->idcustomer->getInputTextType() ?>" data-table="v_piutang_detail" data-field="x_idcustomer" name="x<?= $Grid->RowIndex ?>_idcustomer" id="x<?= $Grid->RowIndex ?>_idcustomer" size="30" placeholder="<?= HtmlEncode($Grid->idcustomer->getPlaceHolder()) ?>" value="<?= $Grid->idcustomer->EditValue ?>"<?= $Grid->idcustomer->editAttributes() ?>>
<div class="invalid-feedback"><?= $Grid->idcustomer->getErrorMessage() ?></div>
</span>
<?php } ?>
<input type="hidden" data-table="v_piutang_detail" data-field="x_idcustomer" data-hidden="1" name="o<?= $Grid->RowIndex ?>_idcustomer" id="o<?= $Grid->RowIndex ?>_idcustomer" value="<?= HtmlEncode($Grid->idcustomer->OldValue) ?>">
<?php } ?>
...
<span id="el<?= $Grid->RowCount ?>_v_piutang_detail_idcustomer">
<span<?= $Grid->idcustomer->viewAttributes() ?>>
<?= $Grid->idcustomer->getViewValue() ?></span>
</span>
<?php if ($Grid->isConfirm()) { ?>
<input type="hidden" data-table="v_piutang_detail" data-field="x_idcustomer" data-hidden="1" name="fv_piutang_detailgrid$x<?= $Grid->RowIndex ?>_idcustomer" id="fv_piutang_detailgrid$x<?= $Grid->RowIndex ?>_idcustomer" value="<?= HtmlEncode($Grid->idcustomer->FormValue) ?>">
<input type="hidden" data-table="v_piutang_detail" data-field="x_idcustomer" data-hidden="1" name="fv_piutang_detailgrid$o<?= $Grid->RowIndex ?>_idcustomer" id="fv_piutang_detailgrid$o<?= $Grid->RowIndex ?>_idcustomer" value="<?= HtmlEncode($Grid->idcustomer->OldValue) ?>">
<?php } ?>
<?php } ?>
</td>
    <?php } ?>
...
<?php if (!$Grid->isConfirm()) { ?>
<?php if ($Grid->idcustomer->getSessionValue() != "") { ?>
<span id="el$rowindex$_v_piutang_detail_idcustomer" class="form-group v_piutang_detail_idcustomer">
<span<?= $Grid->idcustomer->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?= HtmlEncode(RemoveHtml($Grid->idcustomer->getDisplayValue($Grid->idcustomer->ViewValue))) ?>"></span>
</span>
<input type="hidden" id="x<?= $Grid->RowIndex ?>_idcustomer" name="x<?= $Grid->RowIndex ?>_idcustomer" value="<?= HtmlEncode($Grid->idcustomer->CurrentValue) ?>" data-hidden="1">
...
<input type="hidden" data-table="v_piutang_detail" data-field="x_idcustomer" data-hidden="1" name="x<?= $Grid->RowIndex ?>_idcustomer" id="x<?= $Grid->RowIndex ?>_idcustomer" value="<?= HtmlEncode($Grid->idcustomer->FormValue) ?>">
<?php } ?>
<input type="hidden" data-table="v_piutang_detail" data-field="x_idcustomer" data-hidden="1" name="o<?= $Grid->RowIndex ?>_idcustomer" id="o<?= $Grid->RowIndex ?>_idcustomer" value="<?= HtmlEncode($Grid->idcustomer->OldValue) ?>">
</td>
    <?php } ?>
