...
<?php if ($Page->id->Visible) { // id ?>
        <th class="<?= $Page->id->headerCellClass() ?>"><span id="elh_ekspedisi_id" class="ekspedisi_id"><?= $Page->id->caption() ?></span></th>
<?php } ?>
...
<span id="el<?= $Page->RowCount ?>_ekspedisi_id" class="ekspedisi_id">
