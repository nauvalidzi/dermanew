...
<?php if ($Page->idkecamatan->Visible) { // idkecamatan ?>
    <div id="r_idkecamatan" class="form-group row">
        <label id="elh_kelurahan_idkecamatan" for="x_idkecamatan" class="<?= $Page->LeftColumnClass ?>"><?= $Page->idkecamatan->caption() ?><?= $Page->idkecamatan->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->idkecamatan->cellAttributes() ?>>
<span id="el_kelurahan_idkecamatan">
<input type="<?= $Page->idkecamatan->getInputTextType() ?>" data-table="kelurahan" data-field="x_idkecamatan" name="x_idkecamatan" id="x_idkecamatan" size="30" maxlength="7" placeholder="<?= HtmlEncode($Page->idkecamatan->getPlaceHolder()) ?>" value="<?= $Page->idkecamatan->EditValue ?>"<?= $Page->idkecamatan->editAttributes() ?> aria-describedby="x_idkecamatan_help">
