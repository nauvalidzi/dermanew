...
loadjs.ready("head", function () {
    ...
    fproductgrid.emptyRow = function (rowIndex) {
        ...
        if (ew.valueChanged(fobj, rowIndex, "nama", false))
            return false;
        if (ew.valueChanged(fobj, rowIndex, "idkemasanbarang", false))
            return false;
    ...
    fproductgrid.lists.idkemasanbarang = <?= $Grid->idkemasanbarang->toClientList($Grid) ?>;
...
<?php } ?>
<?php if ($Grid->idkemasanbarang->Visible) { // idkemasanbarang ?>
        <th data-name="idkemasanbarang" class="<?= $Grid->idkemasanbarang->headerCellClass() ?>"><div id="elh_product_idkemasanbarang" class="product_idkemasanbarang"><?= $Grid->renderSort($Grid->idkemasanbarang) ?></div></th>
<?php } ?>
...
<?php } ?>
    ...
    <?php } ?>
    <?php if ($Grid->idkemasanbarang->Visible) { // idkemasanbarang ?>
        <td data-name="idkemasanbarang" <?= $Grid->idkemasanbarang->cellAttributes() ?>>
<?php if ($Grid->RowType == ROWTYPE_ADD) { // Add record ?>
<span id="el<?= $Grid->RowCount ?>_product_idkemasanbarang" class="form-group">
    <select
        id="x<?= $Grid->RowIndex ?>_idkemasanbarang"
        name="x<?= $Grid->RowIndex ?>_idkemasanbarang"
        class="form-control ew-select<?= $Grid->idkemasanbarang->isInvalidClass() ?>"
        data-select2-id="product_x<?= $Grid->RowIndex ?>_idkemasanbarang"
        data-table="product"
        data-field="x_idkemasanbarang"
        data-value-separator="<?= $Grid->idkemasanbarang->displayValueSeparatorAttribute() ?>"
        data-placeholder="<?= HtmlEncode($Grid->idkemasanbarang->getPlaceHolder()) ?>"
        <?= $Grid->idkemasanbarang->editAttributes() ?>>
        <?= $Grid->idkemasanbarang->selectOptionListHtml("x{$Grid->RowIndex}_idkemasanbarang") ?>
    </select>
    <div class="invalid-feedback"><?= $Grid->idkemasanbarang->getErrorMessage() ?></div>
<?= $Grid->idkemasanbarang->Lookup->getParamTag($Grid, "p_x" . $Grid->RowIndex . "_idkemasanbarang") ?>
<script>
loadjs.ready("head", function() {
    var el = document.querySelector("select[data-select2-id='product_x<?= $Grid->RowIndex ?>_idkemasanbarang']"),
        options = { name: "x<?= $Grid->RowIndex ?>_idkemasanbarang", selectId: "product_x<?= $Grid->RowIndex ?>_idkemasanbarang", language: ew.LANGUAGE_ID, dir: ew.IS_RTL ? "rtl" : "ltr" };
    options.dropdownParent = $(el).closest("#ew-modal-dialog, #ew-add-opt-dialog")[0];
    Object.assign(options, ew.vars.tables.product.fields.idkemasanbarang.selectOptions);
    ew.createSelect(options);
});
</script>
</span>
<input type="hidden" data-table="product" data-field="x_idkemasanbarang" data-hidden="1" name="o<?= $Grid->RowIndex ?>_idkemasanbarang" id="o<?= $Grid->RowIndex ?>_idkemasanbarang" value="<?= HtmlEncode($Grid->idkemasanbarang->OldValue) ?>">
<?php } ?>
<?php if ($Grid->RowType == ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?= $Grid->RowCount ?>_product_idkemasanbarang" class="form-group">
    <select
...
<?php } ?>
<?php if ($Grid->RowType == ROWTYPE_VIEW) { // View record ?>
<span id="el<?= $Grid->RowCount ?>_product_idkemasanbarang">
<span<?= $Grid->idkemasanbarang->viewAttributes() ?>>
<?= $Grid->idkemasanbarang->getViewValue() ?></span>
</span>
<?php if ($Grid->isConfirm()) { ?>
<input type="hidden" data-table="product" data-field="x_idkemasanbarang" data-hidden="1" name="fproductgrid$x<?= $Grid->RowIndex ?>_idkemasanbarang" id="fproductgrid$x<?= $Grid->RowIndex ?>_idkemasanbarang" value="<?= HtmlEncode($Grid->idkemasanbarang->FormValue) ?>">
<input type="hidden" data-table="product" data-field="x_idkemasanbarang" data-hidden="1" name="fproductgrid$o<?= $Grid->RowIndex ?>_idkemasanbarang" id="fproductgrid$o<?= $Grid->RowIndex ?>_idkemasanbarang" value="<?= HtmlEncode($Grid->idkemasanbarang->OldValue) ?>">
<?php } ?>
<?php } ?>
</td>
    <?php } ?>
...
<input type="hidden" data-table="product" data-field="x_nama" data-hidden="1" name="o<?= $Grid->RowIndex ?>_nama" id="o<?= $Grid->RowIndex ?>_nama" value="<?= HtmlEncode($Grid->nama->OldValue) ?>">
    ...
    <?php } ?>
    <?php if ($Grid->idkemasanbarang->Visible) { // idkemasanbarang ?>
        <td data-name="idkemasanbarang">
<?php if (!$Grid->isConfirm()) { ?>
<span id="el$rowindex$_product_idkemasanbarang" class="form-group product_idkemasanbarang">
    <select
        id="x<?= $Grid->RowIndex ?>_idkemasanbarang"
        name="x<?= $Grid->RowIndex ?>_idkemasanbarang"
        class="form-control ew-select<?= $Grid->idkemasanbarang->isInvalidClass() ?>"
...
<span id="el$rowindex$_product_idkemasanbarang" class="form-group product_idkemasanbarang">
<span<?= $Grid->idkemasanbarang->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?= HtmlEncode(RemoveHtml($Grid->idkemasanbarang->getDisplayValue($Grid->idkemasanbarang->ViewValue))) ?>"></span>
</span>
<input type="hidden" data-table="product" data-field="x_idkemasanbarang" data-hidden="1" name="x<?= $Grid->RowIndex ?>_idkemasanbarang" id="x<?= $Grid->RowIndex ?>_idkemasanbarang" value="<?= HtmlEncode($Grid->idkemasanbarang->FormValue) ?>">
<?php } ?>
<input type="hidden" data-table="product" data-field="x_idkemasanbarang" data-hidden="1" name="o<?= $Grid->RowIndex ?>_idkemasanbarang" id="o<?= $Grid->RowIndex ?>_idkemasanbarang" value="<?= HtmlEncode($Grid->idkemasanbarang->OldValue) ?>">
</td>
    <?php } ?>
