...
<?php if ($Page->selesai->Visible) { // selesai ?>
        <th data-name="selesai" class="<?= $Page->selesai->headerCellClass() ?>"><div id="elh_ijinbpom_selesai" class="ijinbpom_selesai"><?= $Page->renderSort($Page->selesai) ?></div></th>
<?php } ?>
<?php
...
<span id="el<?= $Page->RowCount ?>_ijinbpom_selesai">
