...
<?php if ($Page->idserahterima->Visible) { // idserahterima ?>
    <tr id="r_idserahterima">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_npd_sample_idserahterima"><?= $Page->idserahterima->caption() ?></span></td>
        <td data-name="idserahterima" <?= $Page->idserahterima->cellAttributes() ?>>
<span id="el_npd_sample_idserahterima">
<span<?= $Page->idserahterima->viewAttributes() ?>>
<?= $Page->idserahterima->getViewValue() ?></span>
</span>
</td>
    </tr>
<?php } ?>
