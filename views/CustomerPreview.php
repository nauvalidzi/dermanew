...
<?php if ($Page->idtipecustomer->Visible) { // idtipecustomer ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->idtipecustomer->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?= HtmlEncode($Page->idtipecustomer->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->idtipecustomer->getNextSort() ?>">
...
<?php if ($Page->kodenpd->Visible) { // kodenpd ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->kodenpd->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?= HtmlEncode($Page->kodenpd->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->kodenpd->getNextSort() ?>">
...
<?php if ($Page->hp->Visible) { // hp ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->hp->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?= HtmlEncode($Page->hp->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->hp->getNextSort() ?>">
