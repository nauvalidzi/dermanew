...
<?php if ($Page->idorder_detail->Visible) { // idorder_detail ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->idorder_detail->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?= HtmlEncode($Page->idorder_detail->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->idorder_detail->getNextSort() ?>">
...
<?php if ($Page->jumlahorder->Visible) { // jumlahorder ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->jumlahorder->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?= HtmlEncode($Page->jumlahorder->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->jumlahorder->getNextSort() ?>">
...
<?php if ($Page->stockdo->Visible) { // stockdo ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->stockdo->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?= HtmlEncode($Page->stockdo->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->stockdo->getNextSort() ?>">
...
<?php if ($Page->jumlahkirim->Visible) { // jumlahkirim ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->jumlahkirim->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?= HtmlEncode($Page->jumlahkirim->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->jumlahkirim->getNextSort() ?>">
...
<?php if ($Page->jumlahbonus->Visible) { // jumlahbonus ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->jumlahbonus->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?= HtmlEncode($Page->jumlahbonus->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->jumlahbonus->getNextSort() ?>">
...
<?php if ($Page->totalnondiskon->Visible) { // totalnondiskon ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->totalnondiskon->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?= HtmlEncode($Page->totalnondiskon->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->totalnondiskon->getNextSort() ?>">
...
<?php if ($Page->diskonpayment->Visible) { // diskonpayment ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->diskonpayment->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?= HtmlEncode($Page->diskonpayment->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->diskonpayment->getNextSort() ?>">
...
<?php if ($Page->bbpersen->Visible) { // bbpersen ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->bbpersen->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?= HtmlEncode($Page->bbpersen->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->bbpersen->getNextSort() ?>">
...
<?php if ($Page->totaltagihan->Visible) { // totaltagihan ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->totaltagihan->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?= HtmlEncode($Page->totaltagihan->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->totaltagihan->getNextSort() ?>">
...
<?php if ($Page->blackbonus->Visible) { // blackbonus ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->blackbonus->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?= HtmlEncode($Page->blackbonus->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->blackbonus->getNextSort() ?>">
