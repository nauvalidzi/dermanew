...
<?php if ($Page->title->Visible) { // title ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->title->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?= HtmlEncode($Page->title->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->title->getNextSort() ?>">
...
<?php if ($Page->ijinhaki->Visible) { // ijinhaki ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->ijinhaki->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?= HtmlEncode($Page->ijinhaki->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->ijinhaki->getNextSort() ?>">
