...
<div class="ew-add-div"><!-- page* -->
    ...
    <input type="hidden" data-table="npd_review" data-field="x_idnpd" data-hidden="1" name="x_idnpd" id="x_idnpd" value="<?= HtmlEncode($Page->idnpd->CurrentValue) ?>">
    </span>
    <?php } ?>
...
<input type="<?= $Page->kesimpulan->getInputTextType() ?>" data-table="npd_review" data-field="x_kesimpulan" name="x_kesimpulan" id="x_kesimpulan" size="30" maxlength="255" placeholder="<?= HtmlEncode($Page->kesimpulan->getPlaceHolder()) ?>" value="<?= $Page->kesimpulan->EditValue ?>"<?= $Page->kesimpulan->editAttributes() ?> aria-describedby="x_kesimpulan_help">
