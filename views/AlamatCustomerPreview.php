...
<?php if ($Page->alias->Visible) { // alias ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->alias->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?= HtmlEncode($Page->alias->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->alias->getNextSort() ?>">
...
<?php if ($Page->idprovinsi->Visible) { // idprovinsi ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->idprovinsi->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?= HtmlEncode($Page->idprovinsi->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->idprovinsi->getNextSort() ?>">
...
<?php if ($Page->idkabupaten->Visible) { // idkabupaten ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->idkabupaten->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?= HtmlEncode($Page->idkabupaten->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->idkabupaten->getNextSort() ?>">
...
<?php if ($Page->idkecamatan->Visible) { // idkecamatan ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->idkecamatan->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?= HtmlEncode($Page->idkecamatan->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->idkecamatan->getNextSort() ?>">
...
<?php if ($Page->idkelurahan->Visible) { // idkelurahan ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->idkelurahan->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?= HtmlEncode($Page->idkelurahan->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->idkelurahan->getNextSort() ?>">
...
<?php if ($Page->alamat->Visible) { // alamat ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->alamat->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?= HtmlEncode($Page->alamat->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->alamat->getNextSort() ?>">
...
<?php if ($Page->penerima->Visible) { // penerima ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->penerima->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?= HtmlEncode($Page->penerima->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->penerima->getNextSort() ?>">
