...
<?php if ($Page->idkemasanbarang->Visible) { // idkemasanbarang ?>
        <th data-name="idkemasanbarang" class="<?= $Page->idkemasanbarang->headerCellClass() ?>"><div id="elh_product_idkemasanbarang" class="product_idkemasanbarang"><?= $Page->renderSort($Page->idkemasanbarang) ?></div></th>
<?php } ?>
...
<?= $Page->nama->getViewValue() ?></span>
    ...
    <?php } ?>
    <?php if ($Page->idkemasanbarang->Visible) { // idkemasanbarang ?>
        <td data-name="idkemasanbarang" <?= $Page->idkemasanbarang->cellAttributes() ?>>
<span id="el<?= $Page->RowCount ?>_product_idkemasanbarang">
