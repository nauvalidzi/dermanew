...
<?php if ($Page->idpegawai->Visible) { // idpegawai ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->idpegawai->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?= HtmlEncode($Page->idpegawai->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->idpegawai->getNextSort() ?>">
...
<?php if ($Page->status->Visible) { // status ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->status->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?= HtmlEncode($Page->status->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->status->getNextSort() ?>">
...
<?php if ($Page->targetmulai->Visible) { // targetmulai ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->targetmulai->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?= HtmlEncode($Page->targetmulai->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->targetmulai->getNextSort() ?>">
...
<?php if ($Page->tglmulai->Visible) { // tglmulai ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->tglmulai->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?= HtmlEncode($Page->tglmulai->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->tglmulai->getNextSort() ?>">
...
<?php if ($Page->targetselesai->Visible) { // targetselesai ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->targetselesai->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?= HtmlEncode($Page->targetselesai->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->targetselesai->getNextSort() ?>">
...
<?php if ($Page->tglselesai->Visible) { // tglselesai ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->tglselesai->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?= HtmlEncode($Page->tglselesai->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->tglselesai->getNextSort() ?>">
...
<?php if ($Page->keterangan->Visible) { // keterangan ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->keterangan->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?= HtmlEncode($Page->keterangan->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->keterangan->getNextSort() ?>">
