...
<?php if ($Page->idviskositasbarang->Visible) { // idviskositasbarang ?>
    <tr id="r_idviskositasbarang">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_npd_harga_idviskositasbarang"><?= $Page->idviskositasbarang->caption() ?></span></td>
        <td data-name="idviskositasbarang" <?= $Page->idviskositasbarang->cellAttributes() ?>>
<span id="el_npd_harga_idviskositasbarang">
<span<?= $Page->idviskositasbarang->viewAttributes() ?>>
<?= $Page->idviskositasbarang->getViewValue() ?></span>
</span>
</td>
    </tr>
<?php } ?>
