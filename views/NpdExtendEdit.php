...
<div class="custom-control custom-checkbox d-inline-block">
    <input type="checkbox" class="custom-control-input<?= $Page->readonly->isInvalidClass() ?>" data-table="npd_extend" data-field="x_readonly" name="x_readonly[]" id="x_readonly_732276" value="1"<?= ConvertToBool($Page->readonly->CurrentValue) ? " checked" : "" ?><?= $Page->readonly->editAttributes() ?> aria-describedby="x_readonly_help">
    <label class="custom-control-label" for="x_readonly_732276"></label>
</div>
