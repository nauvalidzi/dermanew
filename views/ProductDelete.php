...
<?php if ($Page->idkemasanbarang->Visible) { // idkemasanbarang ?>
        <th class="<?= $Page->idkemasanbarang->headerCellClass() ?>"><span id="elh_product_idkemasanbarang" class="product_idkemasanbarang"><?= $Page->idkemasanbarang->caption() ?></span></th>
<?php } ?>
...
<span id="el<?= $Page->RowCount ?>_product_idkemasanbarang" class="product_idkemasanbarang">
