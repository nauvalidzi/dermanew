...
loadjs.ready("load", function () {
    // Startup script
    loadjs.ready("jquery",(function(){$("[data-field='x_idnpd']").change((function(){var a=this.id.split("_")[0],e=$(this).val();$.get("<?php echo domain(); ?>/api/get/finalKodeSample/"+e,(function(e){$("#"+a+"_kodesample").val(e.kode)}))}))}));
});
</script>
