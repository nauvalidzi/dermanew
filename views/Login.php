<?php namespace PHPMaker2021\Dermateknonew; ?>
<?php
...
loadjs.ready("load", function () {
    // Startup script
    loadjs.ready("jquery",(function(){$(".login-logo").html('<img src="./images/logo.jpg" />'),$(".content-wrapper").css("marginLeft","0px"),$(".content-wrapper").css("display","block"),$(".form-control").css("width","100%")}));
});
</script>
