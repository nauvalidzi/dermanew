...
<?php } ?>
<?php if ($ijinhaki->selesai->Visible) { // selesai ?>
        <tr id="r_selesai">
            <td class="<?= $ijinhaki->TableLeftColumnClass ?>"><?= $ijinhaki->selesai->caption() ?></td>
            <td <?= $ijinhaki->selesai->cellAttributes() ?>>
<span id="el_ijinhaki_selesai">
<span<?= $ijinhaki->selesai->viewAttributes() ?>>
<?= $ijinhaki->selesai->getViewValue() ?></span>
</span>
</td>
        </tr>
<?php } ?>
