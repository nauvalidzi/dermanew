...
<?php if ($Page->namapemesan->Visible) { // namapemesan ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->namapemesan->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?= HtmlEncode($Page->namapemesan->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->namapemesan->getNextSort() ?>">
...
<?php if ($Page->personincharge->Visible) { // personincharge ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->personincharge->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?= HtmlEncode($Page->personincharge->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->personincharge->getNextSort() ?>">
...
<?php if ($Page->notelp->Visible) { // notelp ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->notelp->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?= HtmlEncode($Page->notelp->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->notelp->getNextSort() ?>">
